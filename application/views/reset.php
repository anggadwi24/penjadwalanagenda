    ...
    <body class="fixed-left" >
            ...
            <div class="card" style="border:none;border-radius:30px;overflow:hidden">
                <div class="card-body">
                    ...
                    <div class="text-center m-b-15">
                      ...
                      <h6 class="text-center mt-4" style="font-size: 22px;">Reset Password</h6>
                      
                    </div>

                    <div class="px-3 pb-3 pt-0">
                        <form class="form-horizontal mt-3" action="<?= base_url('forgot/doReset') ?>" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <div class="input-group-text" style="background:white;"><i class="fas fa-lock"></i></div>
                                        </div>
                                        <input class="form-control" type="password" id="password" required="" name="password" placeholder="Password">
                                        <span class="field-icon" id="toggle"><i class="fas fa-eye"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input class="form-control" type="password" id="password1" required="" name="repassword" placeholder="Re-type Password">
                                        <input type="hidden" name="id" value="<?= encode($row['users_id'])?>">
                                        <span class="field-icon" id="toggle1"><i class="fas fa-eye"></i></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group  text-center row m-t-20">
                                ...
                                <div class="col-12 ">
                                    <button class="btn btn-primary btn-block waves-effect waves-light float-right w-50" type="submit" style="border-radius:5px;">Reset</button>
                                </div>
                            </div>
        ...
        <script>
            ...
            $(document).on('click','#toggle1',function(){
                var pass = $('#password1').attr('type');
                if(pass == 'password'){
                    $('#password1').attr('type','text');
                    $('#toggle1').html('<i class="fas fa-eye-slash"></i>');
                }else{
                    $('#password1').attr('type','password');
                    $('#toggle1').html('<i class="fas fa-eye"></i>');
